                ...
                <section class="selection-list">
                    <div class="list-group">
                        ...
                        <a href="#" class=" list-group-item-action " aria-current="true">
                            <h4 class="inner-heading-modal btn" style="background:#4267b2;color:#fff ;border: 1px solid #4267b2;"><i class="fa-brands fa-facebook fa-s" style="color: #e1e1e1;"></i>continue with
                                Facebook
                            </h4>
                        </a>
                        <!-- Google -->
                        <a href="#" class="btn list-group-item-action " aria-current="true">
                            <h4 class="inner-heading-modal btn" style="background:#fff;color:#000 ;border: 1px solid #e4e5e7;"><i class="fa-brands fa-google fa-s" style="color: #e1e1e1;"></i>continue with Google
                            </h4>
                        </a>
                        <!-- Apple -->
                        <a href="#" class="btn list-group-item-action " aria-current="true">
                            <h4 class="inner-heading-modal btn" style="background:#fff;color:#000 ;border: 1px solid #e4e5e7;"><i class="fa-brands fa-apple fa-s" style="color: #e1e1e1;"></i>continue with Apple
                            </h4>
                        </a>
                        <hr />
                        <?php
                        ...
                        <div class="container">
                            <form action="./curdform/create.php" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-1-12 col-form-label"></label>
                                    <div class="col-sm-1-12">
                                        <input type="text" class="form-control" name="lname" id="inputName" placeholder="Last Name" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-1-12 col-form-label"></label>
                                    <div class="col-sm-1-12">
                                        <input type="email" class="form-control" name="email" id="inputName" placeholder="Email/ Username" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-1-12 col-form-label"></label>
                                ...
                                <div class="form-group row mt-2 mb-2">
                                    <div class="col-sm-1-12 ">
                                        <button type="submit" class="btn " style="background-color: #1dbf73;color:#fff;width:100%;">Continue</button>
                                    </div>
                                </div>
            ...
            <div class="modal-body modal-sm">
                ...
                <section class="selection-list">
                    <div class="list-group">
                        ...
                        <!-- Google -->
                        <a href="#" class="btn list-group-item-action " aria-current="true">
                            <h4 class="inner-heading-modal btn" style="background:#fff;color:#000 ;border: 1px solid #e4e5e7;"><i class="fa-brands fa-google fa-s" style="color: #000;"></i>continue with Google
                            </h4>
                        </a>
                        <!-- Apple -->
                        <a href="#" class="btn list-group-item-action " aria-current="true">
                            <h4 class="inner-heading-modal btn" style="background:#fff;color:#000 ;border: 1px solid #e4e5e7;"><i class="fa-brands fa-apple fa-s" style="color: #000;"></i>continue with Apple
                            </h4>
                        </a>
                        <hr />
                        <?php
                        ...
                        <div class="container">
                            <form action="login.php" method="post">
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-1-12 col-form-label"></label>
                                    <div class="col-sm-1-12">
                                        <input type="email" class="form-control" name="inputName" id="inputName" placeholder="email" required>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-1-12 col-form-label"></label>
                                        <div class="col-sm-1-12">
                                            <input type="password" class="form-control" name="inputName" id="inputName" placeholder="password" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mt-2 mb-2">
                                        <div class="col-sm-1-12 ">
